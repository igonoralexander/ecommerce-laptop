...
<html class="wide wow-animation" lang="en">
  ...
  <head>
  <title> N-Media Studio | Video Gallery </title>
        ...
        <div class="container-fluid">
          ...
          @if((!empty($videos) && $videos->count()))
              <div class="row" id="lightgallery">    
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item" data-aos="fade" data-src="{{ asset ($video->vid) }}" data-sub-html="<h2> {{ $video->title }} </h2><p>{{ $video->desc }}</p>">
                  <video  height="240" controls>
                    <source src= " {{ asset ($video->vid) }} " type="video/mp4" alt="Image">
                  </video>  
                </div>
                @endforeach
            </div>

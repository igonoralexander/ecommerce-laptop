    ...
    <div class="site-section-cover overlay" style="background-image: url('{{ asset('blog/images/hero_1.jpg') }} ');">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-7">
              <span class="d-block mb-3 text-white" data-aos="fade-up">{{$blogs->created_at}} <span class="mx-2 text-primary">&bullet;</span> by Admin </span>
                <h1 class="mb-4" data-aos="fade-up" data-aos-delay="100"> {{$blogs->title}} </h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="{{ asset('blog/images/person_2.jpg') }}" alt="Image">
                  </div>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="{{ asset('blog/images/person_3.jpg') }}" alt="Image">
                  </div>
                  <div class="comment-body">
                    <h3>Chris Meyer</h3>
                    <div class="meta">January 9, 2018 at 2:21pm</div>
                  ...
                  <ul class="children">
                    <li class="comment">
                      <div class="vcard bio">
                        <img src="{{ asset('blog/images/person_5.jpg') }}" alt="Image">
                      </div>
                      <div class="comment-body">
                        <h3>Chintan Patel</h3>
                        <div class="meta">January 9, 2018 at 2:21pm</div>
                      ...
                      <ul class="children">
                        <li class="comment">
                          <div class="vcard bio">
                            <img src="{{ asset('blog/images/person_1.jpg') }}" alt="Image">
                          </div>
                          <div class="comment-body">
                            <h3>Jean Doe</h3>
                            <div class="meta">January 9, 2018 at 2:21pm</div>
                            ...
                            <ul class="children">
                              <li class="comment">
                                <div class="vcard bio">
                                  <img src="{{ asset('blog/images/person_4.jpg') }}" alt="Image">
                                </div>
                                <div class="comment-body">
                                  <h3>Ben Afflick</h3>
                                  <div class="meta">January 9, 2018 at 2:21pm</div>
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <img src="{{ asset('blog/images/person_1.jpg') }}" alt="Image" class="img-fluid mb-4 w-50 rounded-circle">

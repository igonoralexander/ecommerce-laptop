                                ...
                                <ul class="">
                                    ...
                                    <li class="menu-item has-children {{ Request::routeIs(
                                        ...
                                        <ul class="sub-menu" style="display: block;">
                                            <li class="sub-menu-item {{ Route::is('admin.brand.create') ? 'active' : '' }}">
                                                <a href="{{ route('admin.brand.create') }}">
                                                    <div class="text">Add Brand </div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item {{ Route::is('admin.brand.index') ? 'active' : '' }}">
                                    ...
                                    <li class="menu-item has-children {{ Request::routeIs(
                                        ...
                                        <ul class="sub-menu" style="display: block;">
                                            <li class="sub-menu-item {{ Route::is('admin.faqs') ? 'active' : '' }}">
                                                <a href="{{ route('admin.faqs') }}">
                                                    <div class="text">View All</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item {{ Route::is('admin.add-faqs') ? 'active' : '' }}">
                                                <a href="{{ route('admin.add-faqs') }}" class="">

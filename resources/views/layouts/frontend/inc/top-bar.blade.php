<!-- Top bar -->
<div class="tf-top-bar bg_white_line">
                        ...
                        <div dir="ltr" class="swiper tf-sw-top_bar" data-preview="1" data-space="0" data-loop="true" data-speed="1000" data-delay="2000">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <p class="top-bar-text fw-5"> Want to get a USA Used Laptops
                                        <a href="{{ route('shop') }}" title="all collection" class="tf-btn btn-line">Shop now
                                            <i class="icon icon-arrow1-top-left"></i>
                                        </a>
                                    </p>
                                </div>
                                <div class="swiper-slide">
                                    <p class="top-bar-text fw-5">Great news! You can now enjoy free nationwide delivery</a></p>
                                </div>
                                <div class="swiper-slide">
                                    <p class="top-bar-text fw-5">on all orders that exceed ₦300,000.</a></p>
                                </div>
                            </div>
                        </div>
                    </div>

                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row g-4">
                            <form method = "POST" action = "{{ route('blogs.update', $blogs->id) }}"  enctype = "multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="formFileSm" class="form-label"> Change Blog Image </label>
                                    <input class="form-control form-control-sm bg-dark" style = "width:40%" name = "imgBlog" id="formFileSm" type="file" value = "{{ $blogs->imgBlog }}">
                                </div>

                                <div class="mb-3">
                                    <label for="formFileSm" class="form-label"> Blog Title </label>
                                    <input class="form-control form-control-sm bg-dark" style = "width:40%" name = "title" value = "{{ $blogs->title }}" id="formFileSm" type="text">
                                </div>
                                ...
                                <div class="col-12 text-center text-sm-start">
                                    <div class="card card-outline card-info">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <textarea style="width: 100%; height: 425px;" name = "contents" id="summernote" >
                                            {{ $blogs->contents }}
                                            </textarea>
                                        </div>
                                    </div>

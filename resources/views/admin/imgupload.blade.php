        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/viewallcategories.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i> View All Category </a>
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i> Add Photos & Videos </a>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <form method = "POST" action = "{{ route('store.photo') }}"  enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    <label for="formFileSm" class="form-label"> Select Category </label>
                                ...
                                <div class="mb-3">
                                    <label for="file" class="form-label"> Upload Photos </label>
                                    <input class="form-control form-control-sm bg-dark" type="file" name = "images[]" accept = "images/*" multiple >
                                            @error('images')
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <form method = "POST" action = "{{ route('video.store') }}"  enctype = "multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-sm bg-dark" name = "vid" id="formFileSm" type="file">
                                    @error('vid')
										<span class = "text-danger"> {{ $message}} </span>
									@enderror
                                </div>

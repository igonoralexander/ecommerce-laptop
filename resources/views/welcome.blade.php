...
<html class="wide wow-animation" lang="en">
  ...
  <head>
    <title>N-Media Studio | Home </title>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2" data-aos="fade-down">
            <h1 class="mb-0"><a href="/" class="text-black h2 mb-0">N-Media</a></h1>
          </div>
          ...
          <div class="swiper-slide">
              <div class="image-wrap">
                <div class="image-info">
                  <h2 class="mb-3">{{$cate->name}}</h2>
                  <a href="{{ route ('photo-gallery', $cate->id) }}" class="btn btn-outline-white py-2 px-4"> View More </a>
                </div>
                <img src="{{ asset($cate->image)}}" alt="Image">
              </div>
            </div>
        @endforeach

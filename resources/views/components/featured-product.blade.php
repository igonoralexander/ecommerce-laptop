...
<section class="flat-spacing-21">
            <div class="container">
                <div class="flat-title title-lg">
                    <span class="title wow fadeInUp" data-wow-delay="0s">Featured Laptop</span>
                </div>
                <div class="row">
                    <div class="col-md-6">
                                ...
                                <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom"
                                    ...
                                    <div class="swiper-wrapper stagger-wrap">
                                        ...
                                        @foreach($featuredProduct->images as $image)
                                            <!-- black -->
                                            <div class="swiper-slide stagger-item" data-color="red">
                                                <div class="item">
                                                    <img class="lazyload" data-src="{{ asset('storage/' . $image->image) }}"
                                                        src="{{ asset('storage/' . $image->image) }}" alt="{{$featuredProduct->name}}">
                                                </div>
                                            </div>
                                            <!-- red -->
                                        @endforeach
                                            ...
                                            <div class="swiper-slide" data-color="red">
                                                <a href="#" target="_blank" class="item"
                                                    ...
                                                    <img class="tf-image-zoom lazyload"
                                                        ...
                                                        src="{{ asset('storage/' . $image->image) }}" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- red -->
                                        @endforeach
                        ...
                        <div class="tf-product-info-wrap position-relative">
                            ...
                            <div class="tf-product-info-list other-image-zoom">
                                <div class="tf-product-info-title">
                                    <h5><a href="product-detail.html" class="link">{{ $featuredProduct->name }}</a></h5>
                                </div>
                                ...
                                <div class="tf-product-info-price">
                                    <div class="price-on-sale"
                                        id="sale-price" data-price="{{ $featuredProduct->sale_price }}">
                                        ₦{{ $featuredProduct->sale_price }}
                                    </div>

                                    <div class="compare-at-price text_black">₦{{ $featuredProduct->price }}</div>
                                    <!-- <div class="badges-on-sale bg_red-2"><span>9</span>% OFF</div> -->
                                </div>
                                <div class="tf-product-info-liveview">
                                    <div class="liveview-count">38</div>
                                ...
                                <div class="tf-product-info-buy-button">
                                    <form class="">
                                        <a href="javascript:void(0);"
                                            ...
                                            data-sale-price="{{ $featuredProduct->sale_price }}"
                                            data-image="{{ asset('storage/' . ($mainImage->image ?? 'default.jpg')) }}">
                                            <span>Add to cart -&nbsp;</span><span
                                                class="tf-qty-price" id="total-price">₦{{ $featuredProduct->sale_price }}</span>
                                        </a>
                                ...
                                <a href="{{ route('product.detail', $featuredProduct->slug) }}" class="tf-btn btn-line fw-6">View full details<i
